...
export default function Dashboard({
    ...
    return (
        <AppLayout title="Dashboard Kasir">
            <h1 className="mb-6 text-2xl font-bold">Ringkasan Kasir</h1>
            ...
            <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
                ...
                <div className="rounded-lg border-l-4 border-green-500 bg-white p-5 shadow-sm">
                    ...
                    <div className="text-2xl font-bold text-gray-800">
                        Rp{' '}
                        {Number(stats.penerimaan_hari_ini).toLocaleString(
                            'id-ID',
                        )}
                    </div>
                </div>
                <div className="rounded-lg border-l-4 border-purple-500 bg-white p-5 shadow-sm">
                    ...
                    <div className="text-3xl font-bold text-gray-800">
                        {stats.total_transaksi_selesai}
                    </div>
                </div>
                <div className="rounded-lg border-l-4 border-orange-500 bg-white p-5 shadow-sm">
                    <div className="mb-1 text-xs font-semibold text-gray-500 uppercase">
                        Online Menunggu
                    </div>
                    <div className="text-3xl font-bold text-gray-800">
                        {stats.pembayaran_online_menunggu}
                    </div>
                </div>
                <div className="rounded-lg border-l-4 border-cyan-500 bg-white p-5 shadow-sm">
                    <div className="mb-1 text-xs font-semibold text-gray-500 uppercase">
                        Online Paid Hari Ini
                    </div>
                    <div className="text-3xl font-bold text-gray-800">
                        {stats.pembayaran_online_hari_ini}
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                >
                    ...
                    <div className="text-lg font-bold">Pembayaran Offline</div>
                    <div className="mt-1 text-sm text-cyan-50">
                        Lakukan transaksi penjualan langsung (offline)
                    </div>
                </Link>
                <Link
                ...
                >
                    ...
                    <div className="text-lg font-bold">
                        Pantau Pembayaran Online
                    </div>
                    <div className="mt-1 text-sm text-cyan-50">
                        Lihat history dan status pembayaran pelanggan
                    </div>
                </Link>
            </div>
                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {recentTransactions.map((order: any) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 whitespace-nowrap">
                                            <span
                                                className={`inline-flex rounded-full px-2 py-1 text-xs leading-5 font-semibold ${order.payment_status === 'paid' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'}`}
                                            >
