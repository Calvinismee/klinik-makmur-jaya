        ...
        <AppLayout title="Pharmacist Dashboard">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-yellow-500">
                    ...
                    <Link href="/pharmacist/prescriptions" className="text-cyan-600 hover:underline text-sm font-medium">Review Prescriptions &rarr;</Link>
                </div>
                <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500">
                    ...
                    <Link href="/pharmacist/orders" className="text-cyan-600 hover:underline text-sm font-medium">Siapkan Pesanan &rarr;</Link>
                </div>
            </div>
